                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card mb-4">
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="navs-pills-profile" role="tabpanel">
                                        ...
                                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                                            @if ($data->img_profile)
                                                <img src=" {{ asset('storage/photoProfileUser/' . $data->img_profile) }} "
                                                    id="img_profile" alt class="d-block rounded" height="100"
                                                    width="100" />
                                            @else
                                            ...
                                            <div class="button-wrapper">
                                                <label for="photoFile" class="btn btn-primary me-2 mb-4" tabindex="0">
                                                    ...
                                                    <input type="file" id="photoFile" name="photoFile"
                                                        class="account-file-input" onchange="loadFile(event)" hidden
                                                        accept="image/png, image/jpeg">
                                                </label>
                                                <p class="text-muted mb-0">Hanya File Tipe JPG, PNG.<br> Maksimal Ukuran
                                                    File 1Mb
                                                </p>
                                            </div>
                                            <div class="col mx-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="provinsi"
                                                    name="provinsi" value="{{ $data->userAlamat->provinsi }}">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="kabupaten" class="form-label">Kabupaten</label>
                                                <input type="text" class="form-control" id="kabupaten"
                                                    name="kabupaten" value="{{ $data->userAlamat->kabupaten }}">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label for="kecamatan" class="form-label">kecamatan</label>
                                                <input type="text" class="form-control" id="kecamatan"
                                                    name="kecamatan" value="{{ $data->userAlamat->kecamatan }}">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                ...
                                @if (Auth()->user()->role == 'user')
                                    <div class="tab-pane fade" id="navs-pills-perusahaan" role="tabpanel">
                                        <div class="mb-3 col-md-12">
                                            <label for="nama" class="form-label">Nama</label>
                                            <input class="form-control" type="text" id="nama" name="nama"
                                                value="{{ $data->userPerusahaan->nama_perusahaan }}" readonly>
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-md-4">
                                                <label for="email" class="form-label">NPWP Perusahaan</label>
                                                <input class="form-control" type="text" id="email" name="email"
                                                    value="{{ $data->userPerusahaan->npwp_perusahaan }}" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label for="nip" class="form-label">Email Perusahaan</label>
                                                <input type="text" class="form-control" id="nip" name="nip"
                                                    value="{{ $data->userPerusahaan->email_perusahaan }}" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label for="nip" class="form-label">Telp Perusahaan</label>
                                                <input type="text" class="form-control" id="nip" name="nip"
                                                    value="{{ $data->userPerusahaan->telp_perusahaan }}" readonly>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label for="nip" class="form-label">Alamat Perusahaan</label>
                                            <textarea class="form-control" rows="3" disabled>{{ $data->userPerusahaan->telp_perusahaan }}</textarea>
                                        </div>
                                    </div>
                                @endif
                            </div>
